...
# Gemini 2.0 Flash 料金（2025年時点、無料枠超過後）
# 無料枠: 1,500 リクエスト/日・1,000,000 tokens/分（個人利用なら実質無料）
PRICE_INPUT_PER_MTOK  = 0.075      # USD / million tokens
PRICE_OUTPUT_PER_MTOK = 0.30       # USD / million tokens
...
def calc_cost(input_tokens: int, output_tokens: int) -> float:
    """トークン数から USD コストを計算する（Gemini 2.0 Flash 料金、無料枠超過後）。"""
    return (
...
---
*このレビューは Gemini 2.0 Flash によって自動生成されました。*
"""
...
"""
    ...
    print(f"[info] Gemini {MODEL} にリクエスト中...")
