...
# Gemini 2.0 Flash Lite 料金（2025年時点、無料枠超過後）
# 無料枠: 1,500 リクエスト/日（AI Studio キーで利用可能）
...
def calc_cost(input_tokens: int, output_tokens: int) -> float:
    """トークン数から USD コストを計算する（Gemini 2.0 Flash Lite 料金、無料枠超過後）。"""
    return (
...
---
*このレビューは Gemini 2.0 Flash Lite によって自動生成されました。*
"""
