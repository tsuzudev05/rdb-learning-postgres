#!/usr/bin/env python3
"""
ai_review.py — PR diff を Claude Haiku に渡してコードレビューを生成し、
...
必要な環境変数:
    ANTHROPIC_API_KEY  Claude API キー（GitHub Secret に登録）
...
MAX_DIFF_CHARS       = 80_000      # Haiku の入力トークン上限を考慮した文字数上限
MODEL                = "claude-haiku-4-5-20251001"

# Haiku 料金（2025年時点）
PRICE_INPUT_PER_MTOK  = 0.80       # USD / million tokens
PRICE_OUTPUT_PER_MTOK = 4.00       # USD / million tokens
...
---
*このレビューは Claude Haiku によって自動生成されました。*
"""
...
"""
    ...
    print(f"[info] Claude {MODEL} にリクエスト中...")
...
def main() -> None:
    # 環境変数の確認
    required_env = ["ANTHROPIC_API_KEY", "GITHUB_TOKEN", "PR_NUMBER", "REPO"]
